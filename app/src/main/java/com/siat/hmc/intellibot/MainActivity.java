...
public class MainActivity extends AppCompatActivity implements FuncSelectInterface {
    ...
    private static List<Func> flist =  new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flist.add(new Func("Guide Walking", R.mipmap.guide_walking));
        flist.add(new Func("Random Working", R.mipmap.random_working));
        flist.add(new Func("Voice Reading", R.mipmap.voice_reading));
        flist.add(new Func("Language Learning", R.mipmap.language_learning));
        flist.add(new Func("Setting", R.mipmap.setting));
